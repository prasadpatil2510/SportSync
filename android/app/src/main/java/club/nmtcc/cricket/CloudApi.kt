...
data class Delivery(val id:String,val sequence:Int,val batterRuns:Int,val extraRuns:Int,val extraType:String,val wicket:Boolean,val dismissalType:String,val dismissedPlayerId:String,val strikerName:String,val bowlerId:String,val bowlerName:String,val fielderName:String="",val assistantFielderName:String="")
