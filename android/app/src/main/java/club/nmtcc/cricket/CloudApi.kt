...
data class Delivery(val id:String,val sequence:Int,val batterRuns:Int,val extraRuns:Int,val extraType:String,val wicket:Boolean,val dismissalType:String,val dismissedPlayerId:String,val strikerName:String,val bowlerName:String)
